...
def Main():
    ...
    for plugin_id in build_args.plugin_list:
        if plugin_id in CTX.plugins:
            ...
            utility.WarningMessage(f"Ignoring unknown plug-in '{plugin_id}'. Valid options are {PluginID.ACCESSIBILITY}, {PluginID.CORE}, {PluginID.CORE_HAPTICS}, {PluginID.GAME_CONTROLLER}, {PluginID.GAME_KIT}, {PluginID.PHASE}, {PluginID.CLOUD_KIT}, or {PluginID.ALL} (Default)")
